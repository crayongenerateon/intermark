<div class="carousel fade-carousel slide" data-ride="carousel" data-interval="10000" id="bs-carousel">
  ...
  <div class="carousel-inner">
    <div class="item slides active">
      ...
      <div style="position:absolute; z-index:999; bottom:0; right:0; margin-right:50px; margin-bottom:30px;"><h2 style="color:#FFF;"> <i class="ion ion-android-call"></i> +62 21 2917999</h2></div>
      <div class="hero">
        <hgroup>
          <h2>Introduction</h2>        
