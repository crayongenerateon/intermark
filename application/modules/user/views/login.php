...
<head>
    ...
    <title>Intermark<?php echo isset($title) ? ' | ' . $title : null; ?></title><!-- Bootstrap core CSS -->
    ...
    <div class="container-fluid">
        ...
        <nav class="navbar navbar-default navbar-fixed-bottom navzu">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <center>© 2016-2017 Rumah Cipta Generasi<br>Providing Appropriate Information Technology</center>
                    </div>
                </div>
            </div>
        </nav>
