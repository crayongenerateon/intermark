<section class="about-section" style="margin-top: 120px;">
  <center>
    ...
    <h1 class="title">9th-20th Floor</h1>
  </center>
  <div class="index-content">
    <div class="container">
      <div class="col-lg-12">
        <center>
         <img src="<?php echo base_url() ?>\uploads\AssociateTower\9th-20th Floor\highzone.jpg" class="img-responsive" alt="intermark" width="100%">
       </center>
     </div>
   </div>
 </div>
