<section class="about-section" style="margin-top: 120px;">
  <div class="index-content">
    <div class="container">
      <div class="col-lg-5">
        <center>
         <img src="<?php echo base_url() ?>\media\templates\intermark\images\uplouds\SwissBelHotel\Deluxe\Deluxe.jpg" class="img-responsive animated bounceIn" alt="intermark" width="100%">
       </center>
     </div>
     <div class="col-lg-7">
       <center>
